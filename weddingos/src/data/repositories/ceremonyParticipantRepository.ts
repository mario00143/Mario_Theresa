...
import { ceremonyParticipantsStore, ceremonySequenceItemsStore } from '../stores';
...
/** Deletes a participant and removes it from any ceremony sequence item's participant list. */
