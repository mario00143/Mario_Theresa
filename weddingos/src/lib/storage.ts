...
export const STORAGE_KEYS = {
  ...
  churchRequirements: 'churchRequirements',
  ceremonyParticipants: 'ceremonyParticipants',
  ceremonySequenceItems: 'ceremonySequenceItems',
  ceremonyItems: 'ceremonyItems',
  cateringPlans: 'cateringPlans',
  menuItems: 'menuItems',
  decorPlans: 'decorPlans',
  decorDeliverables: 'decorDeliverables',
  attireProfiles: 'attireProfiles',
  attireItems: 'attireItems',
  groomingAppointments: 'groomingAppointments',
  photographyPlans: 'photographyPlans',
  photoGroups: 'photoGroups',
  musicCues: 'musicCues',
  musicAVPlans: 'musicAVPlans',
  giftPlans: 'giftPlans',
  welcomeKits: 'welcomeKits',
  welcomeKitItems: 'welcomeKitItems',
  runSheetItems: 'runSheetItems',
  liveIssues: 'liveIssues',
  dutyAssignments: 'dutyAssignments',
  vendorDayStatuses: 'vendorDayStatuses',
  ceremonyItemMovements: 'ceremonyItemMovements',
  emergencyContacts: 'emergencyContacts',
  emergencyResponseCards: 'emergencyResponseCards',
  closeoutItems: 'closeoutItems',
  finalReadinessReviews: 'finalReadinessReviews',
